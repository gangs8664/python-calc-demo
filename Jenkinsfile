        ...
        stage('SonarQube Analysis') {
            steps {
                ...
                withSonarQubeEnv('My SonarQube') {
                    ...
                    sh ". venv/bin/activate && ${tool 'Default SonarScanner'}/bin/sonar-scanner -Dsonar.projectKey=my-python-calculator -Dsonar.projectName='Python Calculator' -Dsonar.sources=. -Dsonar.language=py -Dsonar.sourceEncoding=UTF-8 -Dsonar.python.version=3.9"
                }
            }
        }
